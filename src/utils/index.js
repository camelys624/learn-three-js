 ...
 */
export function addBasicMaterialSetting(gui, controls, material, name) {
  ...
  folder.add(controls.material, 'vertexColors', {NoColors: THREE.NoColors, FaceColors: THREE.FaceColors, VertexColors: THREE.VertexColors}).onChange(vertexColors => {
...
export function addSpecificMaterialSetting(gui, controls, material, name) {
  controls.material = material;
  ...
  switch (material.type) {
    ...
    case 'MeshPhongMaterial':
      ...
      folder.addColor(controls, 'specular').onChange(e => {
    ...
    case 'MeshStandardMaterial':
      ...
      folder.addColor(controls, 'emissive').onChange( e => {
