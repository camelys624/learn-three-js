...
class HemisphereLightDemo {
    #renderer;
    #camera;

    init() {
        let stats = initStats();
        this.#renderer = initRenderer(undefined, 'hemisphere-light');
        this.#camera = initCamera();

        let trackballControl = initTrackballControls(this.#camera, this.#renderer);
        ...
        let sphereMaterial = new THREE.MeshPhongMaterial({color: 0x7777ff});
...
export default class HemisphereLightElement extends Component {
    componentDidMount() {
        let myHemisphereLight = new HemisphereLightDemo();
        myHemisphereLight.init();
    }
